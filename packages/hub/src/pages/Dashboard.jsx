...
import { Button } from '@distl/shared/components'
    ...
    <div className="max-w-5xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        {[
          ...
          { label: 'Hours This Month', value: '—', icon: Clock },
        ].map((stat) => (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {apps.map((app) => (
          <a
            ...
            className={`bg-white rounded-xl border border-gray-100 p-5 shadow-sm transition-shadow ${
              app.comingSoon ? 'opacity-50 cursor-not-allowed' : 'hover:shadow-md'
            }`}
          >
            <div className="flex items-center gap-3 mb-2">
